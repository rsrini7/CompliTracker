...
const RiskAnalysisDashboard = () => {
  ...
  const fetchRiskData = async () => {
    try {
      ...
      const orgRiskResponse =
        await riskAnalysisService.getOrganizationRiskScore(token);
      setOrganizationRisk(orgRiskResponse.data);

      // Get high risk compliance items
      const highRiskResponse = await complianceService.getComplianceItems(
        token,
        {
          riskLevel: "high",
          limit: 5,
      ...
      const riskFactorsResponse = await riskAnalysisService.getRiskFactors(
        token,
        "overall",
      );
                ...
                <Card.Body className="text-center">
                  ...
                  <Badge
                    bg={getRiskBadgeVariant(
                      organizationRisk?.riskLevel || "medium",
                    )}
                    className="px-3 py-2"
                    style={{ fontSize: "1rem" }}
                  >
                  ...
                  <div className="mt-3 text-muted">
                    Last updated:{" "}
                    {organizationRisk?.lastUpdated
                      ? formatDate(organizationRisk.lastUpdated)
                      : "N/A"}
                  </div>
                </Card.Body>
              </Card>
                    ...
                    <Col md={4}>
                      <div className="text-center mb-3">
                        <h3 className="text-danger mb-0">
                          {organizationRisk?.highRiskCount || 0}
                        </h3>
                    ...
                    <Col md={4}>
                      <div className="text-center mb-3">
                        <h3 className="text-warning mb-0">
                          {organizationRisk?.mediumRiskCount || 0}
                        </h3>
                    ...
                    <Col md={4}>
                      <div className="text-center mb-3">
                        <h3 className="text-success mb-0">
                          {organizationRisk?.lowRiskCount || 0}
                        </h3>
                  ...
                  {highRiskItems.length === 0 ? (
                    <div className="text-center py-3">
                      ...
                      <p className="mt-2 text-muted">
                        No high risk compliance items found.
                      </p>
                    </div>
                  ) : (
          ...
          <Row>
            ...
            <Col md={9}>
              <Card>
                <Card.Header>
                  <h5 className="mb-0">
                    {complianceAreas.find((a) => a.id === selectedArea)?.name ||
                      "Area"}{" "}
                    Risk Factors
                  </h5>
                </Card.Header>
                <Card.Body>
                  {loadingAreaFactors ? (
                    ...
                    <div className="text-center py-3">
                      <p className="text-muted">
                        No risk factors identified for this area.
                      </p>
                    </div>
                  ) : (
                    <Table responsive>
          ...
          <Card>
            <Card.Body>
              ...
              <Alert variant="info">
                ...
                Our AI analyzes your compliance data to predict potential future
              ...
              <Table responsive>
                ...
                <tbody>
                  ...
                  {(!organizationRisk?.predictions ||
                    organizationRisk.predictions.length === 0) && (
                    <tr>
                      <td colSpan="5" className="text-center py-3">
                        <p className="text-muted mb-0">
                          No risk predictions available. Continue adding
                          compliance data to enable AI predictions.
                        </p>
                      </td>
                    </tr>
                  )}
