        ...
        <Alert variant="success" className="mb-4">
          ...
          <p>
            ...
            {formData.requiresSignature &&
              " A signature request has been sent to the specified signatories."}
          </p>
                        ...
                        <div>
                          <div className="mb-3 d-flex align-items-center justify-content-center">
                            {preview ? (
                              ...
                              <i
                                className="bi bi-file-earmark-check text-success"
                                style={{ fontSize: "3rem" }}
                              ></i>
                            )}
                          </div>
          ...
          <Card className="shadow-sm mb-4">
            <Card.Body>
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2">
                  <i className="bi bi-check-circle-fill text-success me-2"></i>
                  For documents requiring signatures, add all signatories before
                  uploading
                </li>
                <li className="mb-2">
                  <i className="bi bi-check-circle-fill text-success me-2"></i>
              ...
              <p className="text-muted">
                Documents requiring signatures will be processed through our
                secure digital signature service. Signatories will receive an
                email with instructions to complete the signature process.
              </p>
              <p className="text-muted mb-0">
                Digital signatures are legally binding and comply with eSign
                regulations.
              </p>
            </Card.Body>
          </Card>
