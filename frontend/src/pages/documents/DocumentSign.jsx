...
const DocumentSign = () => {
  ...
  useEffect(() => {
    ...
    link.href = 'https://fonts.googleapis.com/css2?family=Dancing+Script&family=Indie+Flower&family=Pacifico&family=Roboto&display=swap';
    link.rel = 'stylesheet';
  ...
  const fetchDocumentAndSignatureDetails = async () => {
    try {
      ...
      if (docResponse.data.signatureId) {
        const signatureResponse = await documentService.checkSignatureStatus(currentUser?.token, docResponse.data.signatureId);
  ...
  const handleFontChange = (e) => {
    ...
    if (signatureData.typedSignature) {
      ...
      ctx.textAlign = 'center';
      ctx.textBaseline = 'middle';
      ctx.fillText(signatureData.typedSignature, canvas.width / 2, canvas.height / 2);
            ...
            <Card className="shadow-sm">
              <Card.Body className="text-center p-5">
                ...
                <p className="lead mb-4">
                  Thank you for signing the document. All parties will be notified once everyone has completed their signatures.
                </p>
                <Button 
                  variant="primary" 
                  size="lg"
                  ...
                  <div className="signature-container">
                    ...
                    <div className="mb-4">
                      <div className="d-flex">
                        <Button 
                          variant={signatureData.signatureType === 'draw' ? 'primary' : 'outline-primary'}
                        ...
                        <Button 
                          variant={signatureData.signatureType === 'type' ? 'primary' : 'outline-primary'}
                          className="me-2 flex-grow-1"
                        ...
                        <Button 
                          variant={signatureData.signatureType === 'upload' ? 'primary' : 'outline-primary'}
                    ...
                    {signatureData.signatureType === 'upload' && (
                      <div className="mb-4">
                        <Form.Group controlId="signatureUpload" className="mb-3">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="signature-final-preview border rounded p-3 bg-light">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <div className="text-muted small">Digitally signed by:</div>
                    ...
                    <div className="d-grid gap-2">
                      <Button 
                        ...
                        disabled={!signatureData.name || !signaturePreview || signingInProgress}
                      >
                        {signingInProgress ? (
                          <>
          ...
          <Card className="shadow-sm mb-4">
            <Card.Body>
              ...
              <p className="text-muted small mb-0">
                By clicking "Sign Document", you acknowledge that your electronic signature constitutes your legal signature on this document. 
                This electronic signature is as legally binding as a physical signature under the Electronic Signatures in Global and National Commerce Act (ESIGN).
              </p>
            </Card.Body>
          </Card>
        </Col>
