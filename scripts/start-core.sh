...
# Stop Core Service if running
echo "Stopping Core Service if running..."
kill_port 8082

# Compile Core Service
echo "Compiling Core Service..."
cd services/core-service
./mvnw clean install -DskipTests
check_status "Maven build for Core Service"
...
echo "Core Service is available at http://localhost:8082/api/core"
